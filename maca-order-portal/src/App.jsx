    ...
    try {
      ...
      const mockProducts = [
        ...
        },
        {
          id: 5,
          name: '知恵のポーション',
          description: '記憶力と学習能力を高める学習支援ポーション',
          base_price: 1800
        }
      ]
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-green-600">注文完了</CardTitle>
            <CardDescription>
              ご注文ありがとうございました
            </CardDescription>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">MACA堂 新規注文</h1>
          <p className="text-gray-600">高品質なポーションを法人向けに提供</p>
        </div>
